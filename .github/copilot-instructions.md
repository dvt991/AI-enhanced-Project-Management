...
- `.github\context\` -> Objetivos, stakeholders, riesgos, vision de solucion y session-log
...
- **`.github\tracking\action-tracker.csv`**: acciones criticas y con fecha limite que el PM humano debe cerrar personalmente (reclamaciones, escalaciones, confirmaciones urgentes, aprobaciones pendientes). Delimitador: `;` (punto y coma). Encoding: UTF-8.
